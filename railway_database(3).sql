...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2024 at 05:41 PM
...
('sajjad', 80, 'bu', 'Chittagong Cent', 'Khulna Terminal', 20, 'male', 'booked', '2024-02-14', 'roundTrip', 'adult', 2010, 29, '13:06:24'),
('emon', 81, 'ec', 'Dhaka Junction', 'Rangpur Termina', 40, 'male', 'booked', '2024-02-02', 'oneWay', 'adult', 1090, 29, '13:30:47'),
('araf', 82, 'ec', 'Dhaka Junction', 'Rajshahi Statio', 20, 'male', 'booked', '2024-03-21', 'roundTrip', 'adult', 1060, 28, '08:58:26'),
('abdul', 83, 'ec', 'Dhaka Junction', 'Rajshahi Statio', 25, 'male', 'booked', '2024-03-20', 'oneWay', 'adult', 1060, 39, '18:18:00'),
('Rakib', 84, 'bu', 'Khulna Terminal', 'Khulna Terminal', 20, 'male', 'booked', '2024-03-20', 'roundTrip', 'adult', 0, 48, '17:26:58'),
('Rakib', 85, 'bu', 'Dhaka Junction', 'Chittagong Cent', 40, 'male', 'booked', '2024-03-27', 'roundTrip', 'adult', 1020, 48, '17:30:37'),
('sajjad', 86, 'bu', 'Dhaka Junction', 'Khulna Terminal', 50, 'male', 'booked', '2024-03-28', 'roundTrip', 'children', 1050, 48, '17:31:11');
...
CREATE TABLE `seats_availability` (
  ...
  `date` date NOT NULL,
  `First class` varchar(250) NOT NULL,
...
(1020, 'Sundarban Express', 'Dhaka Junction - Chittagong Central', '08:00:00', 'Dhaka Junction', 'Chittagong Central', '12:00:00'),
(1030, 'Lalmoni Express', 'Chittagong Central - Dhaka Junction', '09:00:00', 'Chittagong Central', 'Dhaka Junction', '13:00:00'),
(1040, 'Silkcity Express', 'Chittagong Central - Rajshahi Station', '10:00:00', 'Chittagong Central', 'Rajshahi Station', '14:00:00'),
(1050, 'Ekota Express', 'Dhaka Junction - Khulna Terminal', '11:00:00', 'Dhaka Junction', 'Khulna Terminal', '15:00:00'),
(1060, 'Parabat Express', 'Dhaka Junction - Rajshahi Station', '12:00:00', 'Dhaka Junction', 'Rajshahi Station', '16:00:00'),
(1070, 'Upakul Express', 'Dhaka Junction - Sylhet Junction', '13:00:00', 'Dhaka Junction', 'Sylhet Junction', '17:00:00'),
(1080, 'Turna Express', 'Dhaka Junction - Barisal Central', '14:00:00', 'Dhaka Junction', 'Barisal Central', '18:00:00'),
(1090, 'Chittra Express', 'Dhaka Junction - Rangpur Terminal', '15:00:00', 'Dhaka Junction', 'Rangpur Terminal', '19:00:00'),
(2000, 'Rangpur Express', 'Dhaka Junction - Comilla Junction', '16:00:00', 'Dhaka Junction', 'Comilla Junction', '20:00:00'),
(2010, 'Nilsagar Express', 'Dhaka Junction - Mymensingh Central', '17:00:00', 'Dhaka Junction', 'Mymensingh Central', '21:00:00'),
(2020, 'Sonar bangla express', 'Dhaka Junction - Jessore Junction', '18:00:00', 'Dhaka Junction', 'Jessore Junction', '22:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `train_rought_tracking`
--

CREATE TABLE `train_rought_tracking` (
  `trainID` int(40) NOT NULL,
  `status` varchar(70) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `train_rought_tracking`
--

INSERT INTO `train_rought_tracking` (`trainID`, `status`) VALUES
(1020, 'Sundarban Express is already in Chittagong junction'),
(1030, 'Lalmoni Express is currently in route'),
(1040, 'Silkcity Express is already in Rajshahi junction'),
(1050, 'Ekota Express is currently in route'),
(1060, 'Parabat Express is currently in route'),
(1070, 'Upakul Express is already in Sylhet junction'),
(1080, 'Express is currently in route'),
(1090, 'Chittra Express is currently in route'),
(2000, 'Rangpur Express is currently in route'),
(2010, 'Nilsagar Express is currently in route'),
(2020, 'Sonar bangla express is currently in route');
...
(36, 'sajjad', 'hosen', 'sajjad@gmail.com', '1122', 'male', 'married', '0000-00-00', '01824010930'),
(38, 'abdur', 'RAhim', 'rahdddi@gmail.com', '111', 'female', 'married', '2024-02-20', '0011141'),
(39, 'Raihan', 'ahmed', 'abduffgggl25@gmail.com', '12345', 'female', 'unmarried', '2024-03-17', '5555'),
(40, 'Rakib', 'Ullah', 'rakib25@gmail.com', 'rakib26521', 'male', 'married', '2024-03-19', '0125555858'),
(41, 'Rakib', 'Ullah', 'rakib256@gmail.com', '552032', 'male', 'married', '2024-03-20', '0125555858'),
(43, 'Rakib', 'Ullah', 'rakib2556@gmail.com', '552032', 'male', 'married', '2024-03-20', '0125555858'),
(44, 'Rakib', 'Ullah', 'rakib25056@gmail.com', '552032', 'male', 'married', '2024-03-20', '0125555858'),
(45, 'Rakib', 'Ullah', 'rakib2526@gmail.com', '552032', 'male', 'married', '2024-03-20', '0125555858'),
(46, 'Rakib', 'Ullah', 'rakib252622@gmail.com', '552032', 'male', 'married', '2024-03-20', '0125555858'),
(47, 'Rakib', 'Ullah', 'rakib2526225@gmail.com', '552032', 'male', 'married', '2024-03-20', '0125555858'),
(48, 'Rakib', 'Ullah', 'rakib2005@gmail.com', '552032', 'male', 'married', '2024-03-13', '0125555858');
...
--
ALTER TABLE `booking`
  MODIFY `Booking_number` int(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
